...
def move(detect, poseX, poseY):
    ...
    LoadingArea = [162.3, 191.4, 95.2, 170.55, -0.1, -50.76]
    aboveLoading = [162.3, 191.4, 125.2, 170.55, -0.1, -50.76]
    detect.mc.send_coords(aboveLoading, 40, 1)
    time.sleep(3)
    detect.mc.send_coords(LoadingArea, 40, 1)
    time.sleep(3)
    detect.pump_on()
    time.sleep(3)
    detect.mc.send_coords(aboveLoading, 40, 1)
...
def play_tic_tac_toe_with_cobot(detect, cap):
...
if __name__ == "__main__":
    ...
    play_tic_tac_toe_with_cobot(detect, cap)